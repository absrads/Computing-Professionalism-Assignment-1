...
\newcommand{\studA}{{HAZAN, Leo}}
\newcommand{\studB}{{BUCKLE, William}}
\newcommand{\studC}{{ANSTED, Emerson}}
\newcommand{\studD}{{CRONIN, Lauren-Grace}}
% ADD ANOTHER LINE FOR A FIFTH MEMBER
%
% IMPORTANT - Then give your SIDs
\newcommand{\sidA}{{550480855}}
\newcommand{\sidB}{{530658678}}
\newcommand{\sidC}{{520442911}}
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{CMD_Line_push_Willd.png}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{GitHub_Clone_Willd.png}
\end{figure}

\begin{figure}[h!]
    \centering
    \includegraphics[width=0.9\textwidth]{pdflatex_Willd.png}
\end{figure}
